...
function Library:AttemptSave()
    if Library.SaveSytems then
        Library.SaveSytems:Save();
    end;
end;
...
function Library:UpdateScrolling(scrolling, list)
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        Library:UpdateScrolling(LeftSide, LeftList)
        Library:UpdateScrolling(RightSide, RightList)
